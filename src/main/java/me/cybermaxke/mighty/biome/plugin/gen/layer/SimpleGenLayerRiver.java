...
public class SimpleGenLayerRiver extends GenLayerRiver {
	private final List<BiomeBase> biomes;

	public SimpleGenLayerRiver(long baseSeed, GenLayer parent, List<BiomeBase> biomes) {
	...
	public int[] a(int x, int z, int height, int width) {
		if (this.biomes.contains(BiomeBase.RIVER)) {
